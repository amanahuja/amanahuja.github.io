...
*Originally published on my old blog, [Pafnuty blog](https://pafnuty.wordpress.com). Reposted here as an effort to [consolidate writing](/posts/consolidating-my-writing/) into one place. The original publication date was: September 26, 2013.*
...
{{< figure src="ss_message_type.png" alt="Disqus events by message_type" caption="Disqus events by message_type" >}}
...
{{< figure src="ss_hist_posts.png" alt="Histogram of events by time" caption="Histogram of events by time" >}}
