---
title: "Tom Bodine Math Rap: \"Order It's Done\""
date: 2011-03-31
author: "Aman Ahuja"
series:
  - pafnuty-blog
...
*Originally published on my old blog, [Pafnuty blog](https://pafnuty.wordpress.com/2011/03/31/bodine-order-its-done/). Reposted here as an effort to [consolidate writing](/posts/consolidating-my-writing/) into one place. The original publication date was: March 31, 2011.*
...
[![PEMDAS](tm_pemdas.png "tm_pemdas")](tm_pemdas.png)
...
*(to chorus)*
[![Tom Bodine Equation 01](tm_eq01.png?w=211 "tm_eq01")](tm_eq01.png)3 times the quantity (5 – 7) that's *cubed*Then we're adding 65 over 13 that's the problem, dude
...
[![Tom Bodine Equation 02](tm_eq02.png "tm_eq02")](tm_eq02.png)It's not just for arithmetic, you can solve equations like
6x – 9 + 2x = 4x – 5
First you gotta simplify on both sides of the “=” sign
Combine your like terms on the left, and you're left 8x – 9

[![Remember backtracking!](tm_backtracking.png "tm_backtracking")](tm_backtracking.png)To break this lil' equation down
Turn your operations 'round
Gotta add or subtract on both sides
Before you can multiply or divide anymore
[![](tm_eq03.png "tm_eq03")](tm_eq03.png)Subtract 4x from both sides
4x – 9 = –5
