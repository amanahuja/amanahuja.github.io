...
*Originally published on [pafnuty.wordpress.com](https://pafnuty.wordpress.com/2013/10/30/andrews-curves-now-free-with-python-pandas-reading-log/) in October 2013. Reposted here as part of pulling old writing into one place.*
...
[caption id="attachment\_1184" align="aligncenter" width="391"]![SO_andrewscurves_03](so_andrewscurves_03.png "Example Andrews Plot") Example: Andrews Plot of randomly generated data[/caption]
...
[caption id="attachment\_1187" align="aligncenter" width="403"]![SO_andrewscurves_04_column_order](so_andrewscurves_04_column_order.png) Andrew's Curves on the same dataset (airquality), but with changed column order.[/caption]
...
[caption id="attachment\_1194" align="aligncenter" width="397"]![SO_andrewscurves_06_column_order](so_andrewscurves_06_column_order.png) Andrew's Curves on the same dataset (mtcars), but with changed column order.[/caption]
...
[caption id="attachment\_1201" align="aligncenter" width="724"]![AndrewsCurves_ss01_vsPCP_shuffle_columns](andrewscurves_ss01_vspcp_shuffle_columns.png "Andrews v. PCP with column order shuffles. ") On the left are Andrew's Curves, and the right column of figures are Parallel Coordinate Plots. Each row has a different column order. [Used the mtcars dataset with 'gear' as the class column. ][/caption]
